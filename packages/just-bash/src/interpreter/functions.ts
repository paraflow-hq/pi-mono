...
import type { FunctionDefNode, HereDocNode, RedirectionNode, WordNode } from "../ast/types.js";
...
export function executeFunctionDef(ctx: InterpreterContext, node: FunctionDefNode): ExecResult {
 ...
 */
async function processInputRedirections(ctx: InterpreterContext, redirections: RedirectionNode[]): Promise<string> {
	let stdin = "";
