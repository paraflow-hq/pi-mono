 ...
 */
async function executeCommandSubstitutionFromString(ctx: InterpreterContext, commandStr: string): Promise<string> {
	// Parse the command
 ...
 */
export function expandVariablesInPattern(ctx: InterpreterContext, pattern: string): string {
	let result = "";
	let i = 0;
 ...
 */
function expandVariablesInDoubleQuotedPattern(ctx: InterpreterContext, content: string): string {
	let result = "";
	let i = 0;
 ...
 */
export async function expandVariablesInPatternAsync(ctx: InterpreterContext, pattern: string): Promise<string> {
	let result = "";
	let i = 0;
 ...
 */
async function expandVariablesInDoubleQuotedPatternAsync(ctx: InterpreterContext, content: string): Promise<string> {
	let result = "";
	let i = 0;
