...
import type { ParameterExpansionPart, SubstringOp, WordNode, WordPart } from "../../ast/types.js";
...
export async function handleSimplePositionalExpansion(
	...
	const result = [prefix + params[0], ...params.slice(1, -1), params[params.length - 1] + suffix];
	return { values: result, quoted: true };
}
