 ...
 */
export function handleSimpleArrayExpansion(ctx: InterpreterContext, wordParts: WordPart[]): ArrayExpansionResult {
 ...
 */
export function handleNamerefArrayExpansion(ctx: InterpreterContext, wordParts: WordPart[]): ArrayExpansionResult {
	if (wordParts.length !== 1 || wordParts[0].type !== "DoubleQuoted") {
		return null;
	}
