...
export async function executeIf(ctx: InterpreterContext, node: IfNode): Promise<ExecResult> {
	let stdout = "";
	let stderr = "";
...
export async function executeFor(ctx: InterpreterContext, node: ForNode): Promise<ExecResult> {
...
export async function executeCStyleFor(ctx: InterpreterContext, node: CStyleForNode): Promise<ExecResult> {
...
export async function executeWhile(ctx: InterpreterContext, node: WhileNode, stdin = ""): Promise<ExecResult> {
	let stdout = "";
	let stderr = "";
	let exitCode = 0;
	let iterations = 0;
...
export async function executeUntil(ctx: InterpreterContext, node: UntilNode): Promise<ExecResult> {
	let stdout = "";
	let stderr = "";
	let exitCode = 0;
	let iterations = 0;
...
export async function executeCase(ctx: InterpreterContext, node: CaseNode): Promise<ExecResult> {
