 ...
 */
function serializeCompoundCommand(node: CommandNode | StatementNode | StatementNode[]): string {
 ...
 */
export async function findFirstInPath(ctx: TypeCommandContext, name: string): Promise<string | null> {
