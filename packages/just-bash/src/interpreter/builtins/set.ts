 ...
 */
function setShellOption(ctx: InterpreterContext, optionKey: keyof ShellOptions | null, value: boolean): void {
	if (optionKey !== null) {
 ...
 */
function formatAssocArrayOutput(ctx: InterpreterContext, arrayName: string): string {
 ...
 */
function setPositionalParameters(ctx: InterpreterContext, params: string[]): void {
