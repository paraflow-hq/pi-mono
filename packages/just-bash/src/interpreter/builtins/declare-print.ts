 ...
 */
export function printSpecificVariables(ctx: InterpreterContext, names: string[]): ExecResult {
	let stdout = "";
	let stderr = "";
 ...
 */
export function printAllVariables(ctx: InterpreterContext, filters: PrintAllFilters): ExecResult {
