...
export async function handleCompgen(ctx: InterpreterContext, args: string[]): Promise<ExecResult> {
	// Parse options
 ...
 */
function getVariableNames(ctx: InterpreterContext, prefix: string | null): string[] {
 ...
 */
function getExportedVariableNames(ctx: InterpreterContext, prefix: string | null): string[] {
 ...
 */
function getFunctionNames(ctx: InterpreterContext, prefix: string | null): string[] {
 ...
 */
function getAliasNames(ctx: InterpreterContext, prefix: string | null): string[] {
	const names: string[] = [];
 ...
 */
async function getDirectoryCompletions(ctx: InterpreterContext, prefix: string | null): Promise<string[]> {
 ...
 */
async function getFileCompletions(ctx: InterpreterContext, prefix: string | null): Promise<string[]> {
	const results: string[] = [];
 ...
 */
async function getCommandCompletions(ctx: InterpreterContext, prefix: string | null): Promise<string[]> {
 ...
 */
async function expandWordlistString(ctx: InterpreterContext, wordlist: string): Promise<string> {
 ...
 */
function restoreEnv(ctx: InterpreterContext, saved: Map<string, string | undefined>): void {
