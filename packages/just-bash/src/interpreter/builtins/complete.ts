...
const VALID_OPTIONS = ["bashdefault", "default", "dirnames", "filenames", "noquote", "nosort", "nospace", "plusdirs"];

export function handleComplete(ctx: InterpreterContext, args: string[]): ExecResult {
 ...
 */
function printCompletionSpecs(ctx: InterpreterContext, commands?: string[]): ExecResult {
