 ...
 */
export async function handlePushd(ctx: InterpreterContext, args: string[]): Promise<ExecResult> {
 ...
 */
export function handlePopd(ctx: InterpreterContext, args: string[]): ExecResult {
	const stack = getStack(ctx);
 ...
 */
export function handleDirs(ctx: InterpreterContext, args: string[]): ExecResult {
	const stack = getStack(ctx);
