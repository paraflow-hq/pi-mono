 ...
 */
async function evaluateArrayIndex(ctx: InterpreterContext, indexExpr: string): Promise<number> {
	try {
 ...
 */
export function getLocalVarDepth(ctx: InterpreterContext, name: string): number | undefined {
 ...
 */
export function clearLocalVarDepth(ctx: InterpreterContext, name: string): void {
 ...
 */
export function pushLocalVarStack(ctx: InterpreterContext, name: string, currentValue: string | undefined): void {
 ...
 */
export function clearLocalVarStackForScope(ctx: InterpreterContext, scopeIndex: number): void {
