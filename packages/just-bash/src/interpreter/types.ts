...
export interface LocalScopingState {
	 ...
	 */
	localVarStack?: Map<string, Array<{ value: string | undefined; scopeIndex: number }>>;
	/**
...
export interface InterpreterContext {
	...
	execFn: (script: string, options?: { env?: Record<string, string>; cwd?: string }) => Promise<ExecResult>;
