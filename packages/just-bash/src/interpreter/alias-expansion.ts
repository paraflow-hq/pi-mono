 ...
 */
function getAlias(ctx: AliasExpansionContext, name: string): string | undefined {
 ...
 */
function handleComplexAlias(node: SimpleCommandNode, aliasValue: string): SimpleCommandNode {
