...
export class ArithmeticError extends ControlFlowError {
	...
	constructor(message: string, stdout: string = "", stderr: string = "", fatal = false) {
 ...
 */
export function isScopeExitError(error: unknown): error is BreakError | ContinueError | ReturnError {
