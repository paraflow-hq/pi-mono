 ...
 */
export function markNamerefInvalid(ctx: InterpreterContext, name: string): void {
 ...
 */
export function resolveNameref(ctx: InterpreterContext, name: string, maxDepth = 100): string | undefined {
 ...
 */
export function getNamerefTarget(ctx: InterpreterContext, name: string): string | undefined {
	if (!isNameref(ctx, name)) {
		return undefined;
	}
