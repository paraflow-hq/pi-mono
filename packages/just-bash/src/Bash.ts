...
import { type CustomCommand, createLazyCustomCommand, isLazyCommand } from "./custom-commands.js";
...
import { Interpreter, type InterpreterOptions, type InterpreterState } from "./interpreter/index.js";
import { type ExecutionLimits, resolveLimits } from "./limits.js";
import { createSecureFetch, type NetworkConfig, type SecureFetch } from "./network/index.js";
...
import type { BashExecResult, Command, CommandRegistry, FeatureCoverageWriter, TraceCallback } from "./types.js";
...
export class Bash {
	...
	async exec(commandLine: string, options?: ExecOptions): Promise<BashExecResult> {
