 ...
 */
export function toBuffer(content: FileContent, encoding?: BufferEncoding): Uint8Array {
 ...
 */
export function fromBuffer(buffer: Uint8Array, encoding?: BufferEncoding | null): string {
	if (encoding === "base64") {
