...
import type { ArithAssignmentOperator, ArithExpr, ArithmeticExpressionNode } from "../ast/types.js";
 ...
 */
export function parseArithmeticExpression(_p: Parser, input: string): ArithmeticExpressionNode {
 ...
 */
function makeMissingOperandError(op: string, pos: number): { expr: ArithExpr; pos: number } {
	return {
		expr: {
			type: "ArithSyntaxError",
			errorToken: op,
...
export function parseArithExpr(p: Parser, input: string, pos: number): { expr: ArithExpr; pos: number } {
	// Comma operator has the lowest precedence
	return parseArithComma(p, input, pos);
}

function parseArithComma(p: Parser, input: string, pos: number): { expr: ArithExpr; pos: number } {
...
function parseArithTernary(p: Parser, input: string, pos: number): { expr: ArithExpr; pos: number } {
...
function parseArithLogicalOr(p: Parser, input: string, pos: number): { expr: ArithExpr; pos: number } {
...
function parseArithLogicalAnd(p: Parser, input: string, pos: number): { expr: ArithExpr; pos: number } {
...
function parseArithBitwiseOr(p: Parser, input: string, pos: number): { expr: ArithExpr; pos: number } {
...
function parseArithBitwiseXor(p: Parser, input: string, pos: number): { expr: ArithExpr; pos: number } {
...
function parseArithBitwiseAnd(p: Parser, input: string, pos: number): { expr: ArithExpr; pos: number } {
...
function parseArithEquality(p: Parser, input: string, pos: number): { expr: ArithExpr; pos: number } {
...
function parseArithRelational(p: Parser, input: string, pos: number): { expr: ArithExpr; pos: number } {
...
function parseArithShift(p: Parser, input: string, pos: number): { expr: ArithExpr; pos: number } {
...
function parseArithAdditive(p: Parser, input: string, pos: number): { expr: ArithExpr; pos: number } {
...
function parseArithMultiplicative(p: Parser, input: string, pos: number): { expr: ArithExpr; pos: number } {
...
function parseArithPower(p: Parser, input: string, pos: number): { expr: ArithExpr; pos: number } {
...
function parseArithUnary(p: Parser, input: string, pos: number): { expr: ArithExpr; pos: number } {
...
function parseArithPostfix(p: Parser, input: string, pos: number): { expr: ArithExpr; pos: number } {
