...
export function parseIf(p: Parser, options?: { skipRedirections?: boolean }): IfNode {
...
export function parseFor(p: Parser, options?: { skipRedirections?: boolean }): ForNode | CStyleForNode {
...
function parseCStyleFor(p: Parser, options?: { skipRedirections?: boolean }, startLine?: number): CStyleForNode {
...
export function parseWhile(p: Parser, options?: { skipRedirections?: boolean }): WhileNode {
...
export function parseUntil(p: Parser, options?: { skipRedirections?: boolean }): UntilNode {
...
export function parseCase(p: Parser, options?: { skipRedirections?: boolean }): CaseNode {
...
export function parseSubshell(p: Parser, options?: { skipRedirections?: boolean }): SubshellNode | CStyleForNode {
...
export function parseGroup(p: Parser, options?: { skipRedirections?: boolean }): GroupNode {
