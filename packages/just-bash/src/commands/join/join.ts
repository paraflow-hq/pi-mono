 ...
 */
function parseLine(line: string, separator: string | null, joinField: number, ignoreCase: boolean): ParsedLine {
 ...
 */
function formatOutputLine(line1: ParsedLine | null, line2: ParsedLine | null, options: JoinOptions): string {
 ...
 */
function parseOutputFormat(format: string): Array<{ file: number; field: number }> | null {
