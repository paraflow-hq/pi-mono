 ...
 */
function prepareHeaders(options: CurlOptions, contentType?: string): Record<string, string> {
 ...
 */
async function saveCookies(options: CurlOptions, headers: Record<string, string>, ctx: CommandContext): Promise<void> {
