...
> = {
	...
	filter: {
		...
		options: ["-v, --invert    invert match", "-l, --limit N   limit output rows"],
	},
	search: {
		name: "xan search",
	...
	select: {
		...
		options: ["Supports: col names, indices (0,1), ranges (a:c), globs (vec_*), negation (!col)"],
	},
	explode: {
		name: "xan explode",
	...
	implode: {
		...
		options: ["-s, --sep SEP        separator (default: |)", "-r, --rename NAME    rename column"],
	},
	join: {
		name: "xan join",
