...
export async function cmdFilter(args: string[], ctx: CommandContext): Promise<ExecResult> {
	let invert = false;
...
export async function cmdSort(args: string[], ctx: CommandContext): Promise<ExecResult> {
	let column = "";
	let numeric = false;
	let reverse = false;
	const fileArgs: string[] = [];
...
export async function cmdDedup(args: string[], ctx: CommandContext): Promise<ExecResult> {
	let column = "";
	const fileArgs: string[] = [];
...
export async function cmdTop(args: string[], ctx: CommandContext): Promise<ExecResult> {
	let n = 10;
	let column = "";
	let reverse = false;
	const fileArgs: string[] = [];
