...
export async function cmdAgg(args: string[], ctx: CommandContext): Promise<ExecResult> {
	let expr = "";
...
export async function cmdGroupby(args: string[], ctx: CommandContext): Promise<ExecResult> {
	let groupCols = "";
	let aggExpr = "";
	const fileArgs: string[] = [];
...
export async function cmdFrequency(args: string[], ctx: CommandContext): Promise<ExecResult> {
...
export async function cmdStats(args: string[], ctx: CommandContext): Promise<ExecResult> {
	let columns: string[] = [];
	const fileArgs: string[] = [];
