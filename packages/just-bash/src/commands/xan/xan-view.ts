 ...
 */
export async function cmdFlatten(args: string[], ctx: CommandContext): Promise<ExecResult> {
...
export async function cmdView(args: string[], ctx: CommandContext): Promise<ExecResult> {
