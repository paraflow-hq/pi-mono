...
import { type CsvRow, createSafeRow, formatCsv, readCsvInput, safeSetRow } from "./csv.js";

export async function cmdSelect(args: string[], ctx: CommandContext): Promise<ExecResult> {
...
export async function cmdDrop(args: string[], ctx: CommandContext): Promise<ExecResult> {
	// First positional arg is column spec, rest are files
	let colSpec = "";
	const fileArgs: string[] = [];
...
export async function cmdRename(args: string[], ctx: CommandContext): Promise<ExecResult> {
...
export async function cmdEnum(args: string[], ctx: CommandContext): Promise<ExecResult> {
	let colName = "index";
