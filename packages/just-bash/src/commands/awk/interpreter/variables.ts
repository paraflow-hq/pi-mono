 ...
 */
export function setVariable(ctx: AwkRuntimeContext, name: string, value: AwkValue): void {
	switch (name) {
		case "FS":
 ...
 */
export function getArrayElement(ctx: AwkRuntimeContext, array: string, key: string): AwkValue {
 ...
 */
export function setArrayElement(ctx: AwkRuntimeContext, array: string, key: string, value: AwkValue): void {
	// Resolve aliases for function parameter passing
	const resolvedArray = resolveArrayName(ctx, array);
 ...
 */
export function hasArrayElement(ctx: AwkRuntimeContext, array: string, key: string): boolean {
	if (array === "ARGV") {
 ...
 */
export function deleteArrayElement(ctx: AwkRuntimeContext, array: string, key: string): void {
	// Resolve aliases for function parameter passing
	const resolvedArray = resolveArrayName(ctx, array);
	if (ctx.arrays[resolvedArray]) {
