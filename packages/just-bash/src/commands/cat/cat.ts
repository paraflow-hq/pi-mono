...
const catHelp = {
	...
	options: ["-n, --number           number all output lines", "    --help             display this help and exit"],
};
...
function addLineNumbers(content: string, startLine: number): { content: string; nextLineNumber: number } {
