...
import type { Command, CommandContext, ExecResult, FeatureCoverageWriter } from "../../types.js";
import { hasHelpFlag, showHelp, unknownOption } from "../help.js";
import { createInitialState, type ExecuteContext, executeCommands } from "./executor.js";
import { parseMultipleScripts } from "./parser.js";
import type { RangeState, SedCommand, SedExecutionLimits, SedState } from "./types.js";
...
async function processContent(
	...
	const sedLimits: SedExecutionLimits | undefined = limits ? { maxIterations: limits.maxSedIterations } : undefined;
