 ...
 */
export function setPath(value: QueryValue, path: (string | number)[], newVal: QueryValue): QueryValue {
	...
	const obj =
		value && typeof value === "object" && !Array.isArray(value) ? nullPrototypeCopy(value) : Object.create(null);
	// @banned-pattern-ignore: protected by Object.hasOwn() check before access
	const currentVal = Object.hasOwn(obj, head) ? (obj as Record<string, unknown>)[head] : undefined;
	safeSet(obj as Record<string, unknown>, head, setPath(currentVal, rest, newVal));
	return obj;
}
 ...
 */
export function deletePath(value: QueryValue, path: (string | number)[]): QueryValue {
