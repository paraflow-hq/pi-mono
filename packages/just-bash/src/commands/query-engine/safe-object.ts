 ...
 */
export function safeAssign<T>(target: Record<string, T>, source: Record<string, T>): Record<string, T> {
 ...
 */
export function nullPrototypeCopy<T extends object>(obj: T): T & Record<string, unknown> {
 ...
 * This prevents prototype chain lookups without filtering any keys.
 */
export function nullPrototypeMerge<T extends object>(...objs: T[]): T & Record<string, unknown> {
