 ...
 */
export function buildRegex(pattern: string, options: RegexOptions): RegexResult {
 ...
 */
function applyInlineModifiers(pattern: string, enableMods: string, _disableMods: string): string {
	let result = pattern;
