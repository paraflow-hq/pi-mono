 ...
 */
export function parseUrl(urlString: string): { origin: string; pathname: string; href: string } | null {
	try {
 ...
 */
export function isUrlAllowed(url: string, allowedUrlPrefixes: string[]): boolean {
