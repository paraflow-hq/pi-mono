 ...
 */
export function matchGlob(name: string, pattern: string, options?: MatchGlobOptions | boolean): boolean {
	...
	const opts: MatchGlobOptions = typeof options === "boolean" ? { ignoreCase: options } : (options ?? {});
