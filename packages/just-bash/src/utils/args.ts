 ...
 */
export function parseArgs<T extends Record<string, ArgDef>>(cmdName: string, args: string[], defs: T): ParseResult<T> {
	...
	const flags: Record<string, boolean | string | number | undefined> = Object.create(null);
	for (const [name, def] of Object.entries(defs)) {
